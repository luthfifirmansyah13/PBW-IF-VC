...
- **Menambahkan Tugas**: Membuat tugas baru dengan deskripsi singkat .
- **Menandai Tugas sebagai Selesai**: Tandai tugas yang telah selesai dengan satu klik.
- **Menghapus Tugas**: menghapus tugas yang tidak lagi diperlukan dari daftar Anda.
...
1. **Kloning repositori ini**:
   ```bash
   git clone https://github.com/luthfifirmansyah13/PBW-IF-VC.git
   cd focuslist